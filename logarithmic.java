...
public class logarithmic {
	...
	//logarithmic graph creation window
	...
	protected void createContents() {
		...
		title.setBounds(58, 22, 157, 20);
		title.setText(" y = alogb(x) + c ");
		...
		graphBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseDown(MouseEvent e) {
				...
				coordinates = calculator.calculateLogarithmic(coordinates, userInput[0], userInput[1], userInput[2]);
				...
				try {
					...
					outputLbl.setText("Graph Saved: " + printer.printFromArr(coordinates, 'G', userInput[0], userInput[1], userInput[2], 0));
